...
try {
    ...
    // ২. নিউজফিড ও রিলস/ভিডিও টেবিল (টাইপ, ভিউ এবং রিচ কাউন্টারসহ)
    $pdo->exec("CREATE TABLE IF NOT EXISTS posts (
        id SERIAL PRIMARY KEY,
        username VARCHAR(50) NOT NULL,
        content TEXT NOT NULL,
        post_pic VARCHAR(255) DEFAULT NULL, 
        post_type VARCHAR(20) DEFAULT 'post', -- 'post' (Text/Image) অথবা 'reel' (Video)
        views_count INT DEFAULT 0,            -- ভিডিওর ভিউ ট্র্যাকার
        reach_count INT DEFAULT 0,            -- পোস্টের ইমপ্রেশন বা রিচ ট্র্যাকার
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    )");

    // ৩. লাইক ট্র্যাকিং টেবিল (ইউনিক জোড়া যেন একজন ১ বারই লাইক দিতে পারে)
    ...
    // ৬. ফ্রেন্ডশিপ ও রিকোয়েস্ট টেবিল
